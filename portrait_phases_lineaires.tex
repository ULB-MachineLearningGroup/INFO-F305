\chapter{Portraits de phases de systèmes linéaires}\label{chap:portrait_phases}
    ...
    \section{Points d'équilibre et stabilité}
        ...
        \begin{definition}{Système stable}\label{def:stabilite}
    ...
    \codeword{Matplotlib} permet de tracer des vecteurs de flux par l'intermédiaire de la fonction \codeword{streamplot}. L'utilisation de cette fonction est proche de celle de \codeword{quiver} utilisée pour les vecteurs vitesse, mais permet une visualisation des trajectoires. Cependant, il n'est attendu de l'étudiant·e seulement d'être capable, à la main, de tracer les vecteurs vitesse et quelques trajectoires bien choisies. Un exemple d'utilisation de \codeword{streamplot} est donnée dans le code suivant, et la figure résultante est donnée en figure \ref{fig:vecteurs_flux}:
   ...
   \section{Systèmes non-simples}
    ...
    \section{Diagramme de Poincaré}\label{sec:poincare}
        ...
        \subsection{Trace et déterminant de la matrice décrivant le système}
